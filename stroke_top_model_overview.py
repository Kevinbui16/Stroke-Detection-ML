...
# Danh sách tên của các đặc điểm phân loại trong tập dữ liệu
categorical_features = ['ever_married', 'Residence_type', 'work_type', 'smoking_status']

# Khởi tạo một danh sách rỗng để lưu trữ chỉ số của các đặc điểm phân loại
categorical_features_indices = []

# Duyệt qua từng tên đặc điểm trong danh sách các đặc điểm phân loại
for feature_name in categorical_features:
    # Tìm chỉ số (vị trí cột) của đặc điểm trong tập dữ liệu và thêm vào danh sách
